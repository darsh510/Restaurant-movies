...
db.define_table('general_info',Field('fname',requires=IS_NOT_EMPTY()),Field('city',requires=IS_NOT_EMPTY()),Field('Address',requires=IS_NOT_EMPTY()),Field('Phone'),Field('Email_id',requires=IS_EMAIL(error_message="invalid email")),Field('Pure_Veg','boolean'),Field('Ratings',requires=IS_FLOAT_IN_RANGE(0,5)),Field('menu','upload'))
...
db.define_table('theaters',Field('fname',requires=IS_NOT_EMPTY()),Field('city',requires=IS_NOT_EMPTY()),Field('Address',requires=IS_NOT_EMPTY()),Field('Website'),Field('movie','string'),Field('datei'),Field('coming_soon','string'),Field('price_range'),Field('show_time'))
